...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_NUMBER = "com.example.android.hellotoast.extra.NUMBER";
    @Override
    ...
    */
    ...
    public void launchSecondActivitiy(View view){
        Intent intent = new Intent(this,SecondActivity.class);
        intent.putExtra(EXTRA_NUMBER,Integer.toString(mCount));
