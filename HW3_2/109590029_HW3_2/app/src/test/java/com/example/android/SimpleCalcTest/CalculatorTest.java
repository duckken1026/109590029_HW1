...
public class CalculatorTest {
    ...
    @Test
    public void addTwoNumbersNegative1() {
        double resultAdd = mCalculator.add(-1d,2d);
        assertThat(resultAdd, is(equalTo(1d)));
    }

    @Test
    public void PowTwoNumbersPositve(){
        double resultPow = mCalculator.pow(9d,3d);
        assertThat(resultPow, is(equalTo(729d)));
    }
    ...
    public void PowSecondNumberNegative(){
        double resultPow = mCalculator.pow(2d,-3d);
        assertThat(resultPow, is(equalTo(1/8d)));
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void PowFirstZeroSecondNegative() {
        mCalculator.pow(0d,-1d);
    }

    @Test(expected = IllegalArgumentException.class)
    public void PowFirstNegativeZeroSecondNegative() {
        mCalculator.pow(-0d,-1d);
    }
}